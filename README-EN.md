...
2. **Setup GitHub Secrets (Required + Optional Platforms)**:
   ...
   **GitHub Secret Configuration (⚠️ Name must match exactly):**
   ...
   - **Secret (Value)**: Your Feishu bot Webhook address (link starts with https://www.feishu.cn/flow/api/trigger-webhook/YOUR_FEISHU_KEY
   <br>
   ...
   **Usage Methods:**
   ...
   2. **Get Push URL**:
      - Open Bark App
      - Copy the push URL displayed on the home page (format: `https://api.day.app/YOUR_BARK_KEY
   ...
   **Setup Steps:**
   ...
   1. **View Generated URL**:
      ...
      - Format: `https://hooks.slack.com/services/YOUR_TEAM_ID/YOUR_CHANNEL_ID/YOUR_TOKEN
...
DINGTALK_WEBHOOK_URL=https://oapi.dingtalk.com/YOUR_DINGTALK_WEBHOOK

# WeWork multi-account (2 groups)
WEWORK_WEBHOOK_URL=https://qyapi.weixin.qq.com/cgi-bin/webhook/send?key=YOUR_WECHAT_KEY
